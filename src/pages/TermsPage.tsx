        ...
        <div className="container-app max-w-3xl">
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p>
                After the trial ends, you must subscribe to a paid plan to continue using Nevorai. Your data is
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>Resell or white-label Nevorai without written permission from Nevorai.</li>
              </ul>
            </section>
