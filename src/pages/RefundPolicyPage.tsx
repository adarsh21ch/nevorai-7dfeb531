        ...
        <div className="container-app max-w-3xl">
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            <section>
              ...
              <p className="mb-3">
                We believe in Nevorai. If you subscribe to any paid plan and are not satisfied within
                <strong className="text-foreground"> 7 days of your payment date</strong>, you can request a full refund.
              </p>
              <p>
                This is in addition to our free trial — so you have tried Nevorai for free before paying, and
