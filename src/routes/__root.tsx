...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nevorai — See who's watching" },
      { name: "description", content: "Share your business video. Your prospect can't skip it — and you'll know exactly when they watched it. Nevorai." },
      { name: "author", content: "Nevorai" },
      { name: "keywords", content: "Nevorai, Nevorai, business video, unskippable video, video sharing, video tracking, see who watched" },
      { property: "og:title", content: "Nevorai" },
      { property: "og:description", content: "Share your business video. Your prospect can't skip it — and you'll know exactly when they watched it." },
      { property: "og:site_name", content: "Nevorai" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://flow.nevorai.com" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Nevorai" },
      { name: "twitter:description", content: "Share your business video. Your prospect can't skip it." },
