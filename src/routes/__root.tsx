...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "nFlow by Nevorai" },
      { name: "description", content: "nFlow by Nevorai is a web application for managing marketing funnels, landing pages, and live sessions." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "nFlow by Nevorai" },
      { property: "og:description", content: "nFlow by Nevorai is a web application for managing marketing funnels, landing pages, and live sessions." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "nFlow by Nevorai" },
      { name: "twitter:description", content: "nFlow by Nevorai is a web application for managing marketing funnels, landing pages, and live sessions." },
      ...
      { name: "apple-mobile-web-app-title", content: "nFlow by Nevorai" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "application-name", content: "nFlow by Nevorai" },
    ],
    links: [
