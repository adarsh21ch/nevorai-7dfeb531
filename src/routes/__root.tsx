...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "nFlow" },
      { name: "description", content: "nFlow New is a web application for managing marketing funnels, landing pages, and live sessions." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "nFlow" },
      { property: "og:description", content: "nFlow New is a web application for managing marketing funnels, landing pages, and live sessions." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "nFlow" },
      { name: "twitter:description", content: "nFlow New is a web application for managing marketing funnels, landing pages, and live sessions." },
      ...
      { name: "apple-mobile-web-app-title", content: "nFlow" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "application-name", content: "nFlow" },
    ],
    links: [
